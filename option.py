...
def parse_args():
    ...
    parser.add_argument("--model", type=str, default="network_PS4")
    parser.add_argument("--GPU_ID", type=int, default=0)
    parser.add_argument("--pvt_path", type=str, default="")
    ...
    parser.add_argument("--ckpt_root", type=str, default="./ckpt2/")
    parser.add_argument("--save_root", type=str, default="./output")
    parser.add_argument("--save_msg", type=str, default="")
    parser.add_argument("--save", type=str, default="ckpt2/")
